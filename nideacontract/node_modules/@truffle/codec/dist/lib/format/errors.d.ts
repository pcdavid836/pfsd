 ...
 */
export type ErrorResult = ElementaryErrorResult | ArrayErrorResult | MappingErrorResult | StructErrorResult | MagicErrorResult | TypeErrorResult | TupleErrorResult | FunctionExternalErrorResult | FunctionInternalErrorResult | OptionsErrorResult;
/**
 * An error result for an ABI type
 *
 * @Category General categories
 */
export type AbiErrorResult = UintErrorResult | IntErrorResult | BoolErrorResult | BytesErrorResult | AddressErrorResult | FixedErrorResult | UfixedErrorResult | StringErrorResult | ArrayErrorResult | FunctionExternalErrorResult | TupleErrorResult;
/**
 * One of the underlying errors contained in an [[ErrorResult]]
 *
 * @Category General categories
 */
export type DecoderError = GenericError | UintError | IntError | BoolError | BytesStaticError | BytesDynamicError | AddressError | StringError | FixedError | UfixedError | ArrayError | MappingError | StructError | MagicError | TypeErrorUnion | TupleError | EnumError | UserDefinedValueTypeError | ContractError | FunctionExternalError | FunctionInternalError | InternalUseError;
/**
 * An error result for an elementary value
 *
 * @Category Elementary types
 */
export type ElementaryErrorResult = UintErrorResult | IntErrorResult | BoolErrorResult | BytesErrorResult | AddressErrorResult | StringErrorResult | FixedErrorResult | UfixedErrorResult | EnumErrorResult | UserDefinedValueTypeErrorResult | ContractErrorResult;
/**
 * An error result for a built-in value type
 *
 * @Category Elementary types
 */
export type BuiltInValueErrorResult = UintErrorResult | IntErrorResult | BoolErrorResult | BytesStaticErrorResult | AddressErrorResult | FixedErrorResult | UfixedErrorResult;
/**
 ...
 * @Category User-defined elementary types
 */
export type EnumError = EnumOutOfRangeError | EnumPaddingError | EnumNotFoundDecodingError;
/**
 ...
 * @Category Function types
 */
export type FunctionInternalError = FunctionInternalPaddingError | NoSuchInternalFunctionError | DeployedFunctionInConstructorError | MalformedInternalFunctionError;
/**
 ...
 * @Category Generic errors
 */
export type ReadError = UnsupportedConstantError | ReadErrorStack | ReadErrorBytes | ReadErrorStorage | StorageNotSuppliedError | UnusedImmutableError | CodeNotSuppliedError;
/**
 ...
 */
export type BytesLocation = "memory" | "calldata" | "eventdata" | "returndata" | "code";
/**
 ...
 */
export type InternalUseError = OverlongArrayOrStringStrictModeError | InternalFunctionInABIError | ReEncodingMismatchError;
/**
