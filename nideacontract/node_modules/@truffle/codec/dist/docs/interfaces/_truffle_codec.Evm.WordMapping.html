...
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/3c242ffe4/packages/codec/lib/evm/types.ts#L32">codec/lib/evm/types.ts:32</a></li></ul></aside></div>
...
<li><a href="_truffle_codec.Evm.WordMapping.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Word<wbr/>Mapping</span></a></li></ul></div></details></li>
